...
TITLE CREATE AIRPORT ALIAS FILES

:version_chk

SET USER_VER=1.1

SET GITHUB_VERSION_CHK_URL=https://github.com/KSanders7070/AIRPORT_ALIAS_CREATION/blob/master/Version_Check

SET BATCH_FILE_RELEASES_URL=https://github.com/KSanders7070/AIRPORT_ALIAS_CREATION/releases
