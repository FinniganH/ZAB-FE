...
ECHO the user has access to the ZAB FACILITY DROPBOX
...
ECHO.
ECHO.
ECHO      A) Split a current vERAM ZAB GeoMaps.xml or vSTARS Video Maps.xml into multiple individual files.
ECHO.
ECHO.
ECHO      B) Take the export data from the NASR_2_SCT parser and transfer to coorisponding EDIT files.
ECHO.
ECHO.
ECHO      C) Combine split GeoMaps or Video Maps into a single ZAB GeoMaps.xml or ___ Video Maps.xml file.
echo            - Ensure only the files that you want to combine are in the directory you select.
ECHO.
ECHO.
ECHO      D) Combine and Transfer all EDIT SCT files to the Pre-Release ZAB SECTOR.sct2 file.
ECHO.
ECHO.
ECHO      E) Combine and Transfer all EDIT ALIAS files to the Pre-Release ZAB ALIAS.txt file.
ECHO              ---REMINDER: Launch vSTARS/vERAM, load new Alias/POF/GEOMAPs as needed and
ECHO                 export the .gz to Pre-Release folder.
ECHO.
ECHO.
ECHO      F) Transfer Pre-Release Files to ZAB Public Folder.
ECHO.
ECHO.
...
.BrowseForFolder(0,'Select The Folder That Houses The ZAB GeoMaps.xml',0,0).self.path""
...
echo            Ex: \/:*?"<>|
echo.
echo  2) There is only one BCG, FILTER, and GEOMAPSet and they are all labeled "ZAB".
echo.
echo  3) The .xml to be split MUST be named like so: "ZAB GeoMaps.xml".
echo.
...
ECHO.
ECHO.
ECHO IS THE FOLLOWING DIRECTORY CORRECT FOR THE ZAB GeoMaps.xml THAT YOU WANT TO SPLIT?
ECHO.
...
ECHO.
ECHO.
ECHO Select the directory that the ZAB GeoMaps.xml is in.
ECHO.
ECHO.
...
SET SOURCE_FILE=ZAB GeoMaps.xml
...
echo            Pre-Release\ZAB Facility Files WIP\
...
ECHO.
ECHO.
ECHO  *** EDIT SCT Files to ZAB Pre-Release Folder ***
ECHO.
ECHO.
ECHO -----------------------------------------------
ECHO  PRESS ANY KEY TO REPLACE THE CONTENTS OF THE
ECHO  ZAB PRE-RELEASE SECTOR FILE WITH THE CONTENTS
...
ECHO ----------------------------------------------
ECHO.
ECHO  EXPORTING ALL FILES TO: ZAB SECTOR.SCT2
ECHO.
ECHO  ZAB 2. Internal Facility Files
ECHO     -Pre-Release
ECHO         -ZAB Facility Files WIP
ECHO             -SECTOR FILES
ECHO.
ECHO ----------------------------------------------
ECHO.
...
ECHO --------------------------------------------------------------
ECHO.
ECHO  ALL FILES COMBINED INTO THE PRE-RELEASE: ZAB SECTOR.SCT2
ECHO.
ECHO --------------------------------------------------------------
ECHO.
ECHO.
...
ECHO.
ECHO.
ECHO  *** EDIT ALIAS Files to ZAB Pre-Release Folder ***
ECHO.
ECHO.
...
ECHO -----------------------------------------------
ECHO  PRESS ANY KEY TO REPLACE THE CONTENTS OF THE
ECHO  ZAB PRE-RELEASE ALIAS FILE WITH THE CONTENTS
...
ECHO ----------------------------------------------
ECHO.
ECHO  EXPORTING ALL FILES TO: ZAB ALIAS.txt
ECHO.
ECHO  ZAB 2. Internal Facility Files
ECHO     -Pre-Release
ECHO         -ZAB Facility Files WIP
...
type "*.txt">>"%PR_ALIAS_DIR%\ZAB ALIAS.txt"
echo.>>"%PR_ALIAS_DIR%\ZAB ALIAS.txt"
echo.>>"%PR_ALIAS_DIR%\ZAB ALIAS.txt"
...
ECHO --------------------------------------------------------------
ECHO.
ECHO  ALL FILES COMBINED INTO THE PRE-RELEASE: ZAB ALIAS.txt
ECHO.
ECHO --------------------------------------------------------------
ECHO.
ECHO.
...
ECHO.
ECHO.
ECHO  *** AUTO-TRANSFER Pre-Release Files to ZAB Public Folder ***
echo.
echo.
echo    You Are About To Move The Following Contents From The Pre-Release Folder
echo    To The Appropriate ZAB Public Folder.
echo.
echo.
...
echo.
echo          O)   ZAB "Other Downloads" Folder
echo          A)   Alias File(s)
echo          P)   POF Files(s)
...
echo.
echo.
echo MOVING CONTENTS OF "OTHER DOWNLOADS" TO ZAB PUBLIC FOLDER
echo.
echo.
echo.
echo.
...
echo.
echo.
echo MOVING CONTENTS OF "ALIAS FILES" TO ZAB PUBLIC FOLDER
echo.
echo.
echo.
echo.
...
echo.
echo.
echo MOVING CONTENTS OF "POF FILE" TO ZAB PUBLIC FOLDER
echo.
echo.
echo.
echo.
...
echo.
echo.
echo MOVING CONTENTS OF "SECTOR FILES" TO ZAB PUBLIC FOLDER
echo.
echo.
echo.
echo.
...
echo.
echo.
echo MOVING CONTENTS OF "ZAB vATIS" TO ZAB PUBLIC FOLDER
echo.
echo.
echo.
echo.
